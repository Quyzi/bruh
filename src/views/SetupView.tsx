...
// Default recommended scopes for chat, channel management, and EventSub (Follow, Subscribe, Gift)
const DEFAULT_SCOPES = [
  ...
  "moderator:read:followers", // Required for channel.follow EventSub
  "channel:read:subscriptions", // Required for channel.subscribe and channel.subscription.gift EventSub
];
