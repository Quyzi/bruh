...
export function SendChatFormattedNode(this: any) {
...
SendChatFormattedNode.prototype.onRemoved = function (this: any) {
...
SendChatFormattedNode.title = "Send Chat Formatted";
SendChatFormattedNode.desc = "Send a formatted message to a Twitch channel. Use ?1-?4 as placeholders.";

export function register() {
  LiteGraph.registerNodeType("twitch/send_chat_formatted", SendChatFormattedNode as any);
}
